    ...
    <div className="flex flex-col">
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          ...
          'Use RJ Business Solutions API to integrate with your tools.'
        )}
        <br />
        <a
          className="underline hover:font-bold hover:underline"
          href="https://github.com/rjbizsolution23-wq/postiz-app"
          target="_blank"
        >
          {t(
        ...
        ><br />
          {t(
            'check_n8n',
            'Check out our N8N custom node for RJ Business Solutions.'
          )}
        </a>
      </div>
      ...
      <div className="text-customColor18 mt-[4px]">
        {t(
          ...
          'Connect RJ Business Solutions MCP server to your client (Http streaming) to schedule your posts faster.'
        )}
      </div>
      <div className="my-[16px] mt-[16px] bg-sixth border-fifth items-center border rounded-[4px] p-[24px] flex gap-[24px]">
        <div className="flex items-center">
