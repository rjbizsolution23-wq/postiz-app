  ...
  return [
      ...
      ? [
          {
            title: t(
              ...
              'Am I going to be charged by InstaPost?'
            ),
            description: t(
              'faq_to_confirm_credit_card_information_postiz_will_hold',
              'To confirm credit card information InstaPost will hold $2 and release it immediately'
            ),
          },
        ]
      : []),
    {
      title: t(
        ...
        'Can I trust InstaPost?'
      ),
      description: t(
        'faq_postiz_gitroom_is_proudly_open_source',
        'InstaPost is proudly open-source! We believe in an ethical and transparent culture, meaning that InstaPost will live forever. You can check out the entire code or use it for personal projects. To view the open-source repository, <a href="https://github.com/rjbizsolution23-wq/postiz-app" target="_blank" style="text-decoration: underline;">click here</a>.'
      ),
    },
    {
      ...
      description: t(
        ...
        `InstaPost allows you to schedule your posts between different channels.
